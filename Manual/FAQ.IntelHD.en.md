...
## Intel (U)HD Graphics 610-650 ([Kaby Lake](https://en.wikipedia.org/wiki/Kaby_Lake) and [8th generation Amber Lake Y](https://en.wikipedia.org/wiki/Kaby_Lake#List_of_8th_generation_Amber_Lake_Y_processors) processors)  
Supported since macOS 10.12.6 (`UHD617 8th generation Amber Lake Y` supported since macOS 10.14.1)  
...
**Method 2**  
Use this ACPI table: [SSDT-PNLF.dsl](https://raw.githubusercontent.com/acidanthera/WhateverGreen/master/Manual/SSDT-PNLF.dsl) [SSDT-PNLF.aml](https://i.applelife.ru/2019/09/457190_SSDT-PNLF.aml.zip), for CFL+ use other table [SSDT-PNLFCFL.aml](https://i.applelife.ru/2019/12/463488_SSDT-PNLFCFL.aml.zip)  
