...
Добавьте `shikigva=80` в аргументы загрузки ядра или как DeviceProperty свойство в любую графическую карту. В случае возникновения зависаний используйте `shikigva=16`. Не все виды DRM доступны в разных конфигурациях, следуйте [данной инструкции](https://applelife.ru/posts/846582) для проверки совместимости DRM.
